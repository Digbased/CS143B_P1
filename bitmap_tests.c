...
//	printf("\n");
//
//	//print out pdisk.bufs
//	for(int i = 0;i < 8;++i)
//	{
//		printf("i: %d | %04x\n",i,bitmap[i]);
//	}

	int bitEnabled = io_system.isBitEnabled(32);
...
{
	io_system.enableBit(5);	
	int bitEnabled = io_system.isBitEnabled(5);
...
{
	io_system.enableBit(56);
	int isE = io_system.isBitEnabled(56);
